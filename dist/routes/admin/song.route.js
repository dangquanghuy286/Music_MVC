...
const uploadCloud = __importStar(require("../../middlewares/admin/uploadToCloudinary"));
...
]), uploadCloud.uploadMulti, controller.createPost);
router.patch("/edit/:id", upload.fields([
    { name: "avatar", maxCount: 1 },
    { name: "audio", maxCount: 1 },
]), uploadCloud.uploadMulti, controller.editPatch);
